...
public:
    vector<int> longestObstacleCourseAtEachPosition(vector<int>& obstacles) {
    	//This is a variation of Longest Increasing Subsequence, but here we will check for Longest Non-decreasing subsequence.
    	//LIS and this problem can be solved with a O(n2) solution, but, also with a O(nlogn) Binary+Greedy solution.
