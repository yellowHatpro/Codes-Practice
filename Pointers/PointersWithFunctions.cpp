...
int sum(int a[], int size){
	...
	//That's why we can either give the args in the function as : int a[] or int* a..
	int sum=0;
...
//	print (p);
	...
	cout<<sizeof(a)<<endl;
	cout<<sum(a,10)<<endl;
	//Since the array is passed as a pointer, we can pass the part of an array like this: 
	cout<<sum(a+3,7)<<endl;
